...
if(isset($_POST['vacanta_adauga']))
{
	...
	$query = "INSERT INTO `vacanta` (`link_univ`,`data_start`,`data_stop`) VALUES
...
if(isset($_POST['vacanta_modifica']))
{
	...
	$query = "UPDATE `vacanta` SET `data_start`='".$data_start."',`data_stop`='".$data_sfarsit."'
...
{
	$query = "DELETE FROM `vacanta` WHERE `vac_id`='".$_GET['vacanta_sterge']."' LIMIT 1";
...
$query = "SELECT * FROM `vacanta` WHERE `link_univ`='".$_SESSION['univ_id']."'";
