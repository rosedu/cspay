...
//meniu pentru fiecare tip de cont 
	...
	$menu[2] = 	'
		<ul>
			<li'.equal(9,$select,' class="active"').'><a href="index.php">Acas&#259;</a></li>		
			<li'.equal(0,$select,' class="active"').'><a href="2_conturi.php">Gestiune baz&#259; de date</a></li>
...
//submeniuri secretara
	$submenu[0][1] = '
		<ul>
			<li'.equal(0,$select,' class="subactive"').'><a href="0_incarcare_xls.php">Incarcare formular</a></li>
			<li'.equal(0,$select,' class="subactive"').'><a href="0_verificare_xls.php">Verificare formular</a></li>
