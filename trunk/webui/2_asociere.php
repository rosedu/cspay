...
if(isset($_POST['salveaza_admin']))//formular de modificare parola/utilizator administrator
{
	...
	$query = "UPDATE `utilizatori` SET `utilizator`='".$utilizator."',`parola`='".$parola."'
...
if(isset($_POST['salveaza_materie']))//formular de modificare parola/utilizator conturi materie
{
	...
	{
		$query = "UPDATE `utilizatori` SET `utilizator`='".$utilizator[$i]."',`parola`='".$parola[$i]."'
...
$query = "INSERT INTO `utilizatori` (`materie`,`utilizator`,`parola`,`tip_cont`,`link_univ`)
		  VALUES ";
...
$query = "SELECT * FROM `utilizatori` WHERE `link_univ`='".$_SESSION['univ_id']."' AND
